  ...
  const seedGames = [
    {
      ...
      excerpt:
        'Equipe rubro-negra promoveu live especial para destacar as novidades de Hades II, que chegou ao acesso antecipado com Melinoë como protagonista e planos de atualização constantes.',
      content:
