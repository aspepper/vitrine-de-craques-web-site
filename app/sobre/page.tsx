          ...
          <section className="space-y-8">
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
              ...
              <p className="mt-4 text-lg text-slate-600">
                Propomos novas formas e oportunidades no futebol, com inovação,
            ...
            <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:p-10">
              ...
              <p className="mt-4 text-lg text-slate-600">
                Ser a maior vitrine digital de referência do Brasil — e um novo
                padrão de segurança e ética no futebol.
              </p>
              <p className="mt-4 text-slate-600">
              ...
              <div className="mt-8 grid gap-6 sm:grid-cols-2">
                {valores.map((valor) => (
                  ...
                  >
                    ...
                    <p className="mt-3 text-slate-600">{valor.descricao}</p>
                  </div>
                ))}
              </div>
            </section>

            <div className="flex flex-col gap-6 rounded-3xl border border-slate-200 bg-white p-8 shadow-sm sm:flex-row sm:items-center sm:justify-between sm:p-10">
              <div>
              ...
              <Link
                href="/noticias"
                className="inline-flex items-center justify-center rounded-xl bg-emerald-500 px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-emerald-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-500"
              >
                Acesse o blog
              </Link>
            </div>
